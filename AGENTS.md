...
- **Lint**: `npm run lint` — exits clean (only warnings remain: a few unused `react-hooks/exhaustive-deps` and `<img>` LCP warnings). Treat new errors you introduce as blocking.
