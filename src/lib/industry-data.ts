    ...
    segments: [
      {
        ...
        position: 'upstream',
        companies: [
          { symbol: 'BHP', name: 'BHP Group', note: { zh: '全球最大矿业公司，铁矿+铜+钾肥多元化业务。', en: 'World\'s largest mining company; iron ore + copper + potash diversification.' } },
          { symbol: 'RIO', name: 'Rio Tinto', note: { zh: '全球第二大矿业公司，铁矿石与铝业务核心。', en: 'World\'s #2 mining company; iron ore and aluminum at the core.' } },
          { symbol: 'VALE', name: 'Vale', note: { zh: '巴西最大矿业公司，全球最大铁矿石生产商。', en: 'Brazil\'s largest miner; world\'s largest iron-ore producer.' } },
          { symbol: 'FCX', name: 'Freeport-McMoRan', note: { zh: '全球最大上市铜生产商，能源转型用铜需求最大受益方。', en: 'World\'s largest publicly traded copper producer; key transition-metal beneficiary.' } },
          { symbol: 'SCCO', name: 'Southern Copper', note: { zh: '美洲铜矿生产商，秘鲁与墨西哥矿区，成本优势明显。', en: 'Americas copper producer with Peru and Mexico operations; low-cost position.' } },
          { symbol: 'TECK', name: 'Teck Resources', note: { zh: '加拿大多金属矿业公司，正聚焦铜与锌业务剥离煤炭。', en: 'Canadian diversified miner; focusing on copper / zinc and divesting coal.' } },
        ],
      },
      {
        id: 'gold-silver',
        ...
        position: 'upstream',
        companies: [
          { symbol: 'NEM', name: 'Newmont', note: { zh: '全球最大黄金生产商，并购Newcrest后产能进一步扩大。', en: 'World\'s largest gold producer; production further scaled after the Newcrest acquisition.' } },
          { symbol: 'GOLD', name: 'Barrick Gold', note: { zh: '全球第二大黄金生产商，强非洲与南美矿区敞口。', en: 'World\'s #2 gold producer; meaningful Africa and South America exposure.' } },
          { symbol: 'AEM', name: 'Agnico Eagle Mines', note: { zh: '加拿大最大黄金生产商，单位成本与储备质量行业领先。', en: 'Largest Canadian gold producer; best-in-class unit costs and reserves.' } },
          { symbol: 'KGC', name: 'Kinross Gold', note: { zh: '中型黄金生产商，美洲与西非矿区组合。', en: 'Mid-cap gold producer with Americas + West Africa portfolio.' } },
          { symbol: 'AG', name: 'First Majestic Silver', note: { zh: '墨西哥白银矿业公司，纯白银生产商之一。', en: 'Mexico-based silver miner; one of the few pure-play silver producers.' } },
        ],
      },
      {
        id: 'steel',
        ...
        position: 'midstream',
        companies: [
          { symbol: 'NUE', name: 'Nucor', note: { zh: '美国最大钢铁公司，电炉短流程模式行业标杆。', en: 'Largest US steelmaker; benchmark mini-mill / EAF operator.' } },
          { symbol: 'STLD', name: 'Steel Dynamics', note: { zh: '美国第二大电炉钢厂，正向铝业务扩展。', en: 'US #2 EAF steelmaker; expanding into aluminum.' } },
          { symbol: 'X', name: 'United States Steel', note: { zh: '美国传统综合钢厂，与日本新日铁合并案陷入政治拉锯。', en: 'Heritage US integrated steel; Nippon Steel merger caught in political crossfire.' } },
          { symbol: 'CLF', name: 'Cleveland-Cliffs', note: { zh: '北美最大铁矿石矿业公司，也是综合钢铁生产商。', en: 'Largest NA iron-ore miner and a fully integrated steel producer.' } },
          { symbol: 'RS', name: 'Reliance', note: { zh: '美国最大金属服务中心，钢铁与金属深加工分销。', en: 'Largest US metals service center; processing and distribution.' } },
          { symbol: 'ATI', name: 'ATI Inc', note: { zh: '专业钛合金与高温合金生产商，航空航天核心供应商。', en: 'Specialty titanium and superalloy producer; key aerospace supplier.' } },
        ],
      },
      {
        id: 'aluminum-other',
        ...
        position: 'midstream',
        companies: [
          { symbol: 'AA', name: 'Alcoa', note: { zh: '美国最大铝业公司，铝土矿+氧化铝+电解铝一体化。', en: 'Largest US aluminum company; integrated bauxite + alumina + smelting.' } },
          { symbol: 'CENX', name: 'Century Aluminum', note: { zh: '美国本土电解铝生产商，主营冰岛与美国冶炼厂。', en: 'US-domiciled aluminum smelter with operations in Iceland and the US.' } },
          { symbol: 'KALU', name: 'Kaiser Aluminum', note: { zh: '高端铝制品(航空+汽车+包装)加工商。', en: 'Specialty aluminum-products fabricator for aerospace, auto and packaging.' } },
        ],
      },
      {
        id: 'industrial-gases',
        ...
        position: 'upstream',
        companies: [
          { symbol: 'LIN', name: 'Linde', note: { zh: '全球最大工业气体公司，电子级气体与氢能业务核心。', en: 'World\'s largest industrial gases company; electronic-grade gases and hydrogen are core.' } },
          { symbol: 'APD', name: 'Air Products & Chemicals', note: { zh: '全球第二大工业气体公司，重注氢能大型项目。', en: 'World\'s #2 industrial gases company; betting heavily on mega hydrogen projects.' } },
        ],
      },
      {
        ...
        position: 'midstream',
        companies: [
          { symbol: 'DOW', name: 'Dow', note: { zh: '全球最大综合化工集团之一，主营基础化学品与塑料。', en: 'One of the largest integrated chemicals groups; commodity chemicals and plastics.' } },
          { symbol: 'DD', name: 'DuPont de Nemours', note: { zh: '特种化工巨头，正剥离水务与电子业务以聚焦核心组合。', en: 'Specialty chemicals major; spinning off water and electronics to refocus.' } },
          { symbol: 'LYB', name: 'LyondellBasell Industries', note: { zh: '全球最大聚烯烃生产商之一，受益于北美天然气原料优势。', en: 'One of the largest polyolefin producers; benefits from cheap US gas feedstock.' } },
          { symbol: 'EMN', name: 'Eastman Chemical', note: { zh: '特种化工与材料公司，正向化学回收与可持续材料布局。', en: 'Specialty chemicals and materials company; pushing into chemical recycling.' } },
          { symbol: 'CE', name: 'Celanese', note: { zh: '全球乙酸与高性能工程塑料龙头。', en: 'Global leader in acetic acid and engineered polymers.' } },
          { symbol: 'HUN', name: 'Huntsman', note: { zh: '聚氨酯材料专业化工公司。', en: 'Specialty chemicals focused on polyurethanes.' } },
          { symbol: 'OLN', name: 'Olin', note: { zh: '全球最大氯碱与环氧产品生产商，温彻斯特弹药业务独特。', en: 'World\'s largest chlor-alkali / epoxy producer; unique Winchester ammunition arm.' } },
        ],
      },
      {
        ...
        position: 'downstream',
        companies: [
          { symbol: 'SHW', name: 'Sherwin-Williams', note: { zh: '北美最大建筑涂料公司，直营门店渠道是护城河。', en: 'Largest NA architectural-coatings company; company-owned stores are the moat.' } },
          { symbol: 'PPG', name: 'PPG Industries', note: { zh: '全球工业涂料龙头，汽车与航空航天涂料强。', en: 'Global industrial-coatings leader; strong in auto and aerospace coatings.' } },
          { symbol: 'AXTA', name: 'Axalta Coating Systems', note: { zh: '全球工业涂料专业公司，汽车修复漆与OEM双业务。', en: 'Industrial coatings specialist; refinish and OEM auto coatings.' } },
          { symbol: 'RPM', name: 'RPM International', note: { zh: '专业涂料与密封材料组合，强消费DIY渠道。', en: 'Specialty coatings and sealants; strong DIY consumer channel.' } },
          { symbol: 'ECL', name: 'Ecolab', note: { zh: '全球水处理与卫生服务龙头，B2B订阅服务模式。', en: 'World\'s leading water-treatment and hygiene-services company; B2B subscription model.' } },
        ],
      },
      {
        ...
        position: 'upstream',
        companies: [
          { symbol: 'CTVA', name: 'Corteva', note: { zh: '杜邦农业业务分拆而来，全球种业与农化龙头之一。', en: 'Spun out of DuPont; one of the world\'s leading seed and crop-protection companies.' } },
          { symbol: 'NTR', name: 'Nutrien', note: { zh: '全球最大综合化肥公司，钾肥与氮肥业务并重。', en: 'World\'s largest integrated fertilizer company; potash + nitrogen.' } },
          { symbol: 'MOS', name: 'Mosaic', note: { zh: '全球最大磷肥生产商之一，钾肥业务也在扩张。', en: 'One of the world\'s largest phosphate producers; also growing potash exposure.' } },
          { symbol: 'CF', name: 'CF Industries Holdings', note: { zh: '北美最大氮肥(尿素)生产商，低成本天然气是结构优势。', en: 'Largest NA nitrogen / urea producer; structural advantage from cheap US gas.' } },
          { symbol: 'FMC', name: 'FMC', note: { zh: '全球农药龙头之一，仿制竞争压力下盈利能力下滑。', en: 'Major global crop-protection company; profitability pressured by generic competition.' } },
        ],
      },
      {
        id: 'packaging',
        ...
        position: 'midstream',
        companies: [
          { symbol: 'PKG', name: 'Packaging Corp of America', note: { zh: '美国第三大瓦楞纸箱生产商，盈利能力行业领先。', en: 'US #3 containerboard producer; industry-leading profitability.' } },
          { symbol: 'IP', name: 'International Paper', note: { zh: '北美最大瓦楞纸与包装公司，正并购欧洲DS Smith扩张。', en: 'Largest NA containerboard and packaging company; acquiring DS Smith in Europe.' } },
          { symbol: 'BALL', name: 'Ball Corp', note: { zh: '全球最大铝制饮料罐生产商，正剥离航天业务专精包装。', en: 'World\'s largest aluminum beverage can maker; divested aerospace to focus on packaging.' } },
          { symbol: 'AMCR', name: 'Amcor', note: { zh: '全球最大软包装与硬包装多元化公司。', en: 'World\'s largest diversified flexible and rigid packaging company.' } },
          { symbol: 'SEE', name: 'Sealed Air', note: { zh: '保护性包装与食品包装解决方案龙头(Cryovac/Bubble Wrap)。', en: 'Protective and food packaging leader (Cryovac, Bubble Wrap).' } },
          { symbol: 'BERY', name: 'Berry Global', note: { zh: '塑料包装产品综合制造商，正与Glatfelter合并卫生用品业务。', en: 'Integrated plastic-packaging maker; merging hygiene business with Glatfelter.' } },
          { symbol: 'OI', name: 'O-I Glass', note: { zh: '全球最大玻璃容器制造商。', en: 'World\'s largest glass container manufacturer.' } },
        ],
      },
      {
        ...
        position: 'upstream',
        companies: [
          { symbol: 'VMC', name: 'Vulcan Materials', note: { zh: '美国最大砂石骨料供应商，本地化资源型护城河。', en: 'Largest US aggregates supplier; localized-resource moat.' } },
          { symbol: 'MLM', name: 'Martin Marietta Materials', note: { zh: '美国第二大砂石骨料供应商，并购整合策略积极。', en: 'US #2 aggregates supplier; aggressive M&A strategy.' } },
          { symbol: 'EXP', name: 'Eagle Materials', note: { zh: '美国中型水泥与建材公司。', en: 'Mid-cap US cement and construction-materials company.' } },
          { symbol: 'CRH', name: 'CRH', note: { zh: '全球最大建材公司之一，已迁主上市美国。', en: 'One of the world\'s largest building-materials companies; primary listing moved to the US.' } },
          { symbol: 'JHX', name: 'James Hardie Industries', note: { zh: '全球最大纤维水泥外墙板生产商。', en: 'World\'s largest fiber-cement siding manufacturer.' } },
        ],
      },
      {
        id: 'lithium-battery',
        ...
        position: 'upstream',
        companies: [
          { symbol: 'ALB', name: 'Albemarle', note: { zh: '全球最大锂盐生产商，正受锂价大幅下行冲击。', en: 'World\'s largest lithium producer; under pressure from collapsing lithium prices.' } },
          { symbol: 'SQM', name: 'Sociedad Quimica y Minera', note: { zh: '智利锂业巨头，盐湖提锂成本优势明显。', en: 'Chile-based lithium major; brine extraction provides cost advantage.' } },
          { symbol: 'LAC', name: 'Lithium Americas', note: { zh: '专注开发美国Thacker Pass锂矿的纯锂业公司。', en: 'Pure-play lithium developer focused on the Thacker Pass project in Nevada.' } },
        ],
      },
    ],
  },
    ...
    segments: [
      {
        ...
        position: 'service',
        companies: [
          { symbol: 'AVB', name: 'AvalonBay Communities', note: { zh: '美国最大公寓REIT之一，沿海高端市场为主。', en: 'One of the largest US apartment REITs; coastal premium markets.' } },
          { symbol: 'EQR', name: 'Equity Residential', note: { zh: 'Sam Zell创立的公寓REIT，沿海大都市市场。', en: 'Sam Zell-founded apartment REIT; coastal gateway markets.' } },
          { symbol: 'ESS', name: 'Essex Property Trust', note: { zh: '专注加州沿海公寓的REIT。', en: 'Apartment REIT focused on coastal California.' } },
          { symbol: 'MAA', name: 'Mid-America Apartment', note: { zh: '美国Sun Belt公寓REIT龙头，新供给消化压力中。', en: 'Sun Belt apartment REIT leader; digesting new-supply pressure.' } },
          { symbol: 'UDR', name: 'UDR', note: { zh: '多元化公寓REIT，沿海与Sun Belt组合。', en: 'Diversified apartment REIT spanning coastal and Sun Belt markets.' } },
          { symbol: 'INVH', name: 'Invitation Homes', note: { zh: '美国最大单户独栋出租REIT。', en: 'Largest US single-family rental REIT.' } },
          { symbol: 'AMH', name: 'American Homes 4 Rent', note: { zh: '美国第二大单户独栋出租REIT。', en: 'US #2 single-family rental REIT.' } },
        ],
      },
      {
        id: 'industrial-reits',
        ...
        position: 'service',
        companies: [
          { symbol: 'PLD', name: 'Prologis', note: { zh: '全球最大物流地产REIT，电商与全球供应链转移最大受益方。', en: 'World\'s largest logistics REIT; biggest beneficiary of e-commerce and supply-chain shifts.' } },
          { symbol: 'EGP', name: 'EastGroup Properties', note: { zh: '美国Sun Belt浅深仓储物流REIT。', en: 'Sun Belt shallow-bay industrial REIT.' } },
          { symbol: 'REXR', name: 'Rexford Industrial Realty', note: { zh: '专注南加州物流地产的纯区域型REIT。', en: 'Pure-play industrial REIT focused on Southern California.' } },
          { symbol: 'FR', name: 'First Industrial Realty Trust', note: { zh: '美国多市场轻工业物流REIT。', en: 'US multi-market light-industrial REIT.' } },
          { symbol: 'STAG', name: 'STAG Industrial', note: { zh: '美国二三线城市单租户工业物流REIT。', en: 'Single-tenant industrial REIT focused on secondary US markets.' } },
          { symbol: 'TRNO', name: 'Terreno Realty', note: { zh: '美国沿海六大都市核心物流REIT，高单位租金。', en: 'Industrial REIT focused on six coastal US gateways; high per-foot rents.' } },
        ],
      },
      {
        ...
        companies: [
          { symbol: 'EQIX', name: 'Equinix', note: { zh: '全球最大互连数据中心REIT，主营高密度互联机房。', en: 'World\'s largest interconnection data-center REIT; high-density colocation focus.' } },
          { symbol: 'DLR', name: 'Digital Realty Trust', note: { zh: '全球最大批发型数据中心REIT，超大规模租户业务核心。', en: 'World\'s largest wholesale data-center REIT; hyperscale tenants are core.' } },
        ],
      },
      {
        id: 'tower-reits',
      ...
      },
      {
        ...
        position: 'service',
        companies: [
          { symbol: 'WELL', name: 'Welltower', note: { zh: '美国最大老年住房与医疗REIT，业绩与人口老龄化高度相关。', en: 'Largest US senior-housing and healthcare REIT; aligned with demographic aging.' } },
          { symbol: 'VTR', name: 'Ventas', note: { zh: '美国第二大医疗REIT，老年住房组合占比较高。', en: 'US #2 healthcare REIT; meaningful senior-housing exposure.' } },
          { symbol: 'OHI', name: 'Omega Healthcare Investors', note: { zh: '专注skilled nursing康复护理设施的REIT。', en: 'REIT specialized in skilled nursing facilities.' } },
          { symbol: 'DOC', name: 'Healthpeak Properties', note: { zh: '生命科学+医疗写字楼REIT，与Physicians Realty合并扩大。', en: 'Life science + medical office REIT; scaled up via Physicians Realty merger.' } },
          { symbol: 'MPW', name: 'Medical Properties Trust', note: { zh: '医院REIT，主要租户Steward Health破产是核心风险。', en: 'Hospital REIT; tenant Steward Health bankruptcy is the central risk.' } },
        ],
      },
      {
        id: 'retail-reits',
        ...
        position: 'service',
        companies: [
          { symbol: 'SPG', name: 'Simon Property Group', note: { zh: '美国最大购物中心REIT，主营A级旗舰mall。', en: 'Largest US mall REIT; portfolio focused on Class-A trophy properties.' } },
          { symbol: 'REG', name: 'Regency Centers', note: { zh: '邻里型杂货店锚定购物中心REIT。', en: 'Neighborhood grocery-anchored shopping center REIT.' } },
          { symbol: 'KIM', name: 'Kimco Realty', note: { zh: '美国大型杂货锚定购物中心REIT。', en: 'Large US grocery-anchored shopping center REIT.' } },
          { symbol: 'FRT', name: 'Federal Realty Investment Trust', note: { zh: '美国REIT中分红最连续增长(57+年)的Dividend King。', en: 'A "Dividend King" — the longest unbroken streak of REIT dividend hikes (57+ years).' } },
          { symbol: 'BRX', name: 'Brixmor Property Group', note: { zh: '美国大型杂货锚定购物中心REIT。', en: 'Large US grocery-anchored open-air shopping center REIT.' } },
        ],
      },
      {
        id: 'net-lease-reits',
        ...
        position: 'service',
        companies: [
          { symbol: 'O', name: 'Realty Income', note: { zh: '美国最大净租赁REIT(月度分红)，并购Spirit Realty后规模扩大。', en: 'Largest US net-lease REIT (monthly dividend); scaled up after the Spirit Realty merger.' } },
          { symbol: 'ADC', name: 'Agree Realty', note: { zh: '聚焦投资级零售租户的净租赁REIT。', en: 'Net-lease REIT focused on investment-grade retail tenants.' } },
          { symbol: 'NNN', name: 'NNN REIT', note: { zh: '专注便利店与汽车服务的中型净租赁REIT。', en: 'Mid-cap net-lease REIT focused on convenience and auto services.' } },
          { symbol: 'WPC', name: 'W. P. Carey', note: { zh: '商业地产净租赁REIT，已大幅剥离办公物业。', en: 'Commercial net-lease REIT; already divested most office properties.' } },
        ],
      },
      {
        id: 'office-reits',
        ...
        position: 'service',
        companies: [
          { symbol: 'BXP', name: 'Boston Properties', note: { zh: '美国最大办公写字楼REIT，主营A级写字楼。', en: 'Largest US office REIT; focused on Class-A premier office buildings.' } },
          { symbol: 'ARE', name: 'Alexandria Real Estate Equities', note: { zh: '生命科学专业写字楼REIT，主要租户为生物制药公司。', en: 'Life-sciences specialty office REIT; biopharma tenant base.' } },
          { symbol: 'VNO', name: 'Vornado Realty Trust', note: { zh: '纽约写字楼REIT，混合办公冲击下估值大幅压制。', en: 'New York office REIT; hybrid-work overhang heavily weighs on the multiple.' } },
          { symbol: 'KRC', name: 'Kilroy Realty', note: { zh: '美国西海岸写字楼REIT，科技公司租户为主。', en: 'US West Coast office REIT; tech-tenant heavy.' } },
          { symbol: 'SLG', name: 'SL Green Realty', note: { zh: '纽约曼哈顿最大办公REIT。', en: 'Largest Manhattan office REIT.' } },
        ],
      },
      {
        ...
        position: 'service',
        companies: [
          { symbol: 'PSA', name: 'Public Storage', note: { zh: '美国最大自助仓储REIT。', en: 'Largest US self-storage REIT.' } },
          { symbol: 'EXR', name: 'Extra Space Storage', note: { zh: '美国第二大自助仓储REIT，并购Life Storage后规模扩大。', en: 'US #2 self-storage REIT; scaled up after the Life Storage merger.' } },
          { symbol: 'CUBE', name: 'CubeSmart', note: { zh: '美国第三大自助仓储REIT。', en: 'US #3 self-storage REIT.' } },
          { symbol: 'NSA', name: 'National Storage Affiliates', note: { zh: '美国中型自助仓储REIT。', en: 'Mid-cap US self-storage REIT.' } },
        ],
      },
      {
        ...
        position: 'service',
        companies: [
          { symbol: 'HST', name: 'Host Hotels & Resorts', note: { zh: '美国最大高端酒店REIT，主要租赁给万豪等品牌运营。', en: 'Largest US upscale hotel REIT; properties leased to Marriott and other brands.' } },
          { symbol: 'PK', name: 'Park Hotels & Resorts', note: { zh: '高端会议酒店REIT，希尔顿系品牌为主。', en: 'Upscale convention-hotel REIT; mostly Hilton-branded.' } },
          { symbol: 'RHP', name: 'Ryman Hospitality Properties', note: { zh: '专注大型团体会议酒店与娱乐场所(Grand Ole Opry)的REIT。', en: 'REIT focused on large group-meeting hotels and entertainment (Grand Ole Opry).' } },
          { symbol: 'APLE', name: 'Apple Hospitality REIT', note: { zh: '美国精选服务酒店REIT，万豪与希尔顿系品牌为主。', en: 'US select-service hotel REIT; Marriott and Hilton brands.' } },
        ],
      },
      {
        id: 'mortgage-reits',
        ...
        position: 'service',
        companies: [
          { symbol: 'NLY', name: 'Annaly Capital Management', note: { zh: '美国最大按揭REIT，主营机构MBS。', en: 'Largest US mortgage REIT; agency MBS focus.' } },
          { symbol: 'AGNC', name: 'AGNC Investment', note: { zh: '美国第二大按揭REIT，纯机构MBS组合。', en: 'US #2 mortgage REIT; pure-play agency MBS.' } },
          { symbol: 'STWD', name: 'Starwood Property Trust', note: { zh: '由Starwood Capital管理的商业地产按揭REIT。', en: 'Commercial mortgage REIT managed by Starwood Capital.' } },
          { symbol: 'BXMT', name: 'Blackstone Mortgage Trust', note: { zh: '由黑石管理的商业地产按揭REIT。', en: 'Commercial mortgage REIT managed by Blackstone.' } },
        ],
      },
      {
        ...
        position: 'service',
        companies: [
          { symbol: 'CBRE', name: 'CBRE Group', note: { zh: '全球最大商业地产服务公司，业务覆盖经纪/物管/估值咨询。', en: 'World\'s largest commercial real-estate services firm; brokerage, property mgmt and advisory.' } },
          { symbol: 'JLL', name: 'Jones Lang LaSalle', note: { zh: '全球第二大商业地产服务公司，与CBRE双寡头格局。', en: 'Global #2 commercial real-estate services firm; CBRE / JLL duopoly.' } },
          { symbol: 'CWK', name: 'Cushman & Wakefield', note: { zh: '全球第三大商业地产服务公司。', en: 'Global #3 commercial real-estate services firm.' } },
          { symbol: 'NMRK', name: 'Newmark Group', note: { zh: '美国中型商业地产服务公司，债务咨询业务强。', en: 'Mid-cap US commercial real-estate services firm; strong debt advisory business.' } },
        ],
      },
    ],
  },
    ...
    segments: [
      {
        ...
        companies: [
          { symbol: 'DUK', name: 'Duke Energy', note: { zh: '美国最大受监管电力公司之一，主营东南部市场。', en: 'One of the largest US regulated electric utilities; Southeast US focus.' } },
          { symbol: 'SO', name: 'Southern Company', note: { zh: '美国东南部最大受监管电力公司，Vogtle核电厂主要业主。', en: 'Largest regulated electric utility in the Southeast; main owner of Plant Vogtle nuclear.' } },
          { symbol: 'AEP', name: 'American Electric Power', note: { zh: '美国最大输电网络公司，覆盖11个州。', en: 'Largest US transmission network operator; 11-state footprint.' } },
          { symbol: 'XEL', name: 'Xcel Energy', note: { zh: '美国中西部受监管电力公用事业，清洁能源转型领跑者。', en: 'Midwest regulated electric utility; clean-energy transition leader.' } },
          { symbol: 'EXC', name: 'Exelon', note: { zh: '美国最大输配电力公司，已剥离发电业务。', en: 'Largest US T&D utility; divested generation operations.' } },
          { symbol: 'ED', name: 'Consolidated Edison', note: { zh: '纽约市电力与天然气公用事业。', en: 'New York City electric and gas utility.' } },
          { symbol: 'ES', name: 'Eversource Energy', note: { zh: '新英格兰最大公用事业，已剥离海上风电业务。', en: 'New England\'s largest utility; divested offshore wind business.' } },
          { symbol: 'ETR', name: 'Entergy', note: { zh: '美国南部受监管电力公司，路易斯安那与得州市场。', en: 'Southern US regulated electric; Louisiana and Texas markets.' } },
          { symbol: 'AEE', name: 'Ameren', note: { zh: '美国密苏里与伊利诺伊州受监管电力公用事业。', en: 'Regulated electric utility serving Missouri and Illinois.' } },
          { symbol: 'EVRG', name: 'Evergy', note: { zh: '美国堪萨斯与密苏里州受监管电力公司。', en: 'Regulated electric utility serving Kansas and Missouri.' } },
          { symbol: 'DTE', name: 'DTE Energy', note: { zh: '密歇根州最大电力与天然气公用事业。', en: 'Largest electric and gas utility in Michigan.' } },
          { symbol: 'CMS', name: 'CMS Energy', note: { zh: '密歇根州第二大公用事业。', en: 'Second-largest utility in Michigan.' } },
          { symbol: 'LNT', name: 'Alliant Energy', note: { zh: '威斯康星与爱荷华州受监管电力公司。', en: 'Regulated electric utility serving Wisconsin and Iowa.' } },
        ],
      },
      {
        ...
        position: 'service',
        companies: [
          { symbol: 'NEE', name: 'NextEra Energy', note: { zh: '美国最大可再生能源开发商+佛州电力公用事业。', en: 'Largest US renewable developer + Florida electric utility.' } },
          { symbol: 'BEPC', name: 'Brookfield Renewable Corp', note: { zh: 'Brookfield旗下可再生能源公司股权(C-corp版本)。', en: 'C-corp share class of Brookfield\'s renewables vehicle.' } },
          { symbol: 'BEP', name: 'Brookfield Renewable Partners', note: { zh: 'Brookfield旗下全球可再生能源yieldco(MLP版本)。', en: 'Brookfield\'s global renewables yieldco (LP structure).' } },
          { symbol: 'AES', name: 'AES Corp', note: { zh: '全球电力公用事业，正快速转型可再生能源。', en: 'Global electric utility pivoting fast into renewables.' } },
          { symbol: 'CWEN', name: 'Clearway Energy', note: { zh: '美国可再生能源yieldco，由Global Infrastructure Partners运营。', en: 'US renewable-energy yieldco managed by Global Infrastructure Partners.' } },
          { symbol: 'ORA', name: 'Ormat Technologies', note: { zh: '全球最大地热发电公司。', en: 'World\'s largest geothermal-power company.' } },
        ],
      },
      {
        id: 'ipp-power',
        ...
        companies: [
          { symbol: 'CEG', name: 'Constellation Energy', note: { zh: '美国最大核电运营商，与Microsoft签订核电PPA重启Three Mile Island。', en: 'Largest US nuclear operator; Microsoft PPA to restart Three Mile Island.' } },
          { symbol: 'VST', name: 'Vistra', note: { zh: '美国大型独立发电商，并购Energy Harbor后核电组合扩大。', en: 'Major US IPP; nuclear portfolio expanded via Energy Harbor acquisition.' } },
          { symbol: 'TLN', name: 'Talen Energy', note: { zh: '美国核电与天然气独立发电商，与Amazon签订数据中心电力协议。', en: 'US nuclear + gas IPP; data-center power deal with Amazon.' } },
        ],
      },
      {
        id: 'multi-utilities',
        ...
        position: 'service',
        companies: [
          { symbol: 'SRE', name: 'Sempra', note: { zh: '加州电力天然气+得州输电+LNG出口业务一体化。', en: 'California electric/gas utility + Texas transmission + LNG export business.' } },
          { symbol: 'D', name: 'Dominion Energy', note: { zh: '弗吉尼亚州电力公用事业，正大幅加注海上风电与AI数据中心电力。', en: 'Virginia electric utility; major bet on offshore wind plus AI data-center power.' } },
          { symbol: 'PCG', name: 'PG&E', note: { zh: '加州最大电力公用事业，山火事件后正逐步重塑业务。', en: 'California\'s largest electric utility; rebuilding post-wildfire crisis.' } },
          { symbol: 'PEG', name: 'Public Service Enterprise', note: { zh: '新泽西最大公用事业，核电与受监管输配电业务。', en: 'Largest New Jersey utility; nuclear plus regulated T&D.' } },
          { symbol: 'WEC', name: 'WEC Energy Group', note: { zh: '威斯康星州最大电力天然气公用事业。', en: 'Largest electric and gas utility in Wisconsin.' } },
          { symbol: 'EIX', name: 'Edison International', note: { zh: '南加州爱迪生电力公司母公司，山火法律责任是核心风险。', en: 'Parent of Southern California Edison; wildfire liability is the central risk.' } },
        ],
      },
      {
        id: 'gas-utilities',
        ...
        position: 'service',
        companies: [
          { symbol: 'ATO', name: 'Atmos Energy', note: { zh: '美国最大独立天然气公用事业，主营得州市场。', en: 'Largest independent US natural-gas distribution utility; Texas-centric.' } },
          { symbol: 'NJR', name: 'New Jersey Resources', note: { zh: '新泽西天然气配送+清洁能源开发组合。', en: 'New Jersey gas distribution + clean-energy development.' } },
          { symbol: 'SWX', name: 'Southwest Gas', note: { zh: '美国西南部天然气配送公司。', en: 'Southwest US natural-gas distribution company.' } },
          { symbol: 'OGS', name: 'ONE Gas', note: { zh: '俄克拉荷马与堪萨斯州天然气配送公司。', en: 'Natural-gas distribution utility serving Oklahoma and Kansas.' } },
          { symbol: 'NWN', name: 'Northwest Natural', note: { zh: '美国俄勒冈州天然气配送公司。', en: 'Natural-gas distribution utility in Oregon.' } },
        ],
      },
      {
        id: 'water-utilities',
        ...
        position: 'service',
        companies: [
          { symbol: 'AWK', name: 'American Water Works', note: { zh: '美国最大上市水务公司，覆盖24个州。', en: 'Largest publicly traded US water utility; serves 24 states.' } },
          { symbol: 'WTRG', name: 'Essential Utilities', note: { zh: '美国第二大上市水务公司，并附带天然气配送业务。', en: 'US #2 publicly traded water utility; also operates gas distribution.' } },
          { symbol: 'CWT', name: 'California Water Service', note: { zh: '美国西部最大水务公用事业之一。', en: 'One of the largest western US water utilities.' } },
          { symbol: 'SJW', name: 'SJW Group', note: { zh: '加州圣何塞水务公用事业。', en: 'San Jose, California-based water utility.' } },
        ],
      },
    ],
  },
